...
`douyin-video-chat/` 是 **chat(lobehub-xb / XBorder AI)版** 的带货视频 skill,带**完整方法论**(强 Hook 九宫格 + 产品保真 + 先分镜图再出片),不是裸调模型。
...
与 Codex skill(`douyin-video-replication-share-kit-api-ready/`)的区别:
